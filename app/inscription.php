...
if(isset($_POST['submit']))
{
    ...
    if($check == 0)
    {
        if($password == $password2)
        {
            ...
            $insertion = $bdd -> prepare("INSERT INTO UTILISATEUR(NOM_UTI, PRENOM_UTI, MDP_UTI, ADMINISTRATEUR, CODE_POSTAL, VILLE, MAIL_UTI)
            VALUES(?, ?, ?, ?, ?, ?, ?);");
            $insertion -> execute(array($name, $firstname, $password, $admin, $postalcode, $city, $email));
        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >                
                    ...
                    <?php
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="inscription.php" method="post">
